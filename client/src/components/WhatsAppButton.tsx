/**
 * WhatsAppButton — Botão flutuante de WhatsApp com animação de pulso
 * Design: Warm Corporate / Boutique Imobiliária
 * Verde vibrante com efeito ripple para alta conversão
 */
...
export function WhatsAppButton() {
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 flex flex-col items-end gap-2">
      {/* Tooltip */}
      {showTooltip && (
        <div className="bg-white text-green-900 text-sm font-semibold px-4 py-2 rounded-xl shadow-xl border border-green-100 flex items-center gap-2 animate-fade-in-up max-w-[200px] text-center">
